...
using GEA.Back_end.Employees.Database;
using GEA.Employees.Models;

namespace GEA.Controllers
{
    public class OperatorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,CreatedWhen,CreatedById")] Operator @operator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,CreatedWhen,CreatedById")] Operator @operator)
        {
            if (ModelState.IsValid)
            {
